...
uses
  ...
  IdUDPClient, StdCtrls, IdSocketHandle, IdUDPServer, IdGlobal, ExtCtrls, OSCUtils, ComCtrls, DOM, XMLRead, XMLWrite,
  FileCtrl, JawsCtrls, MMSystem, MidiIn, MidiOut, Vcl.CheckLst,
